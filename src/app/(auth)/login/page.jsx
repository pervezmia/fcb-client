      ...
      <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border border-blue-500/20 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            Welcome Back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-500">FCB</span>
          </h1>
        ...
        {/* Form Component */}
        <Form validationBehavior="aria" onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <TextField isRequired name="email" className="w-full">
            ...
            />
            <FieldError className="text-red-400 text-xs mt-1">Email is required.</FieldError>
          </TextField>
          ...
          <TextField isRequired name="password" className="w-full">
            ...
            <Input 
              ...
              className="w-full bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-500 rounded-xl"
            />
            <FieldError className="text-red-400 text-xs mt-1">Password is required.</FieldError>
          </TextField>
