    ...
    <div className="min-h-screen bg-slate-950 p-6 flex items-center justify-center">
      <div className="w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="flex items-center gap-4 mb-8 border-b border-slate-800 pb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">{adminInfo.name}</h1>
            <p className="text-sm text-slate-400">{adminInfo.email}</p>
            <span className="inline-block mt-2 text-xs bg-emerald-900/50 text-emerald-400 px-3 py-0.5 rounded-full border border-emerald-700/50 font-medium">
              {adminInfo.role}
            </span>
          </div>
        </div>

        {/* অ্যাডমিন স্ট্যাটিস্টিক্স / ওভারভিউ */}
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-slate-800/50 border border-slate-700/50 p-4 rounded-xl flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-lg font-bold text-white">24 Active</h3>
            </div>
          </div>
          <div className="bg-slate-800/50 border border-slate-700/50 p-4 rounded-xl flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-lg font-bold text-emerald-400">Optimal</h3>
            </div>
          </div>
        </div>

        {/* সেটিংস বা অ্যাকশন অপশন */}
