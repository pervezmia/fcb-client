        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto lg:mx-0">
              Track live match fixtures, explore player rosters, manage team stats, and stay updated with everything happening in our club.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <Link href="/players" className="w-full sm:w-auto">
                <Button variant="bordered" className="w-full sm:w-auto border-slate-700 bg-slate-800/50 hover:bg-slate-800 text-slate-200 rounded-xl text-base font-semibold px-8 py-6 transition-colors flex items-center justify-center gap-2">
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-slate-800/80 max-w-lg mx-auto lg:mx-0">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 uppercase tracking-wider mt-1">Active Teams</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-md bg-slate-800/40 border border-slate-700/60 rounded-3xl p-6 backdrop-blur-xl shadow-2xl space-y-6">
              <div className="flex items-center justify-between border-b border-slate-700/60 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-slate-200 tracking-wide uppercase">Next Match Live Preview</span>
                </div>
                <span className="text-xs bg-blue-500/10 text-blue-400 border border-blue-500/20 px-2.5 py-1 rounded-full font-medium">Upcoming</span>
              </div>
              ...
              <div className="flex items-center justify-between py-4">
                <div className="text-center space-y-2 flex-1">
                  ...
                  <p className="text-sm font-bold text-slate-200">FC Boraitola</p>
                </div>
                
                <div className="px-4 text-center">
                  <span className="text-xl font-black text-slate-500">VS</span>
                  <p className="text-[10px] text-slate-400 mt-1">Sunday, 8:00 PM</p>
                </div>
                ...
                <div className="text-center space-y-2 flex-1">
                  ...
                  <p className="text-sm font-bold text-slate-200">Boraitola Tigers</p>
                </div>
              </div>
