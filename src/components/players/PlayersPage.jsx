...
import { containerVariants, itemVariants, MotionLink } from "@/lib/motion/motion";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 pb-16">
      ...
      <motion.div
        ...
        className="bg-slate-900 border-b border-slate-800 px-4 sm:px-6 lg:px-8 py-8 shadow-lg"
      >
          ...
          {categoriesToDisplay.map((category, idx) => (
            category.players.length > 0 && (
              <div key={idx} className="space-y-6">
                ...
                {/* Category Title */}
                <motion.div variants={itemVariants} className="flex items-center justify-between border-b border-slate-800 pb-3">
